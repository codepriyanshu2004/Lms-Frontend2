...
function HomePage(){
    return(
        <HomeLayout >
           <div className="pt-10 text-white flex items-center justify-center gap-10 h-[90vh] bg-gray-800">
                <div className=" w-1/2 space-y-6">
                  <h1 className="text-5xl font-semibold"> 
                   ...
                   <p className="text-xl text-gray-200">
                      we have a large libray of courses taught by highly skilled and qualified faculties at a very affordable cost.
                   </p>
