...
import Priyanshu from "../assets/NakuriProfile.png"

function AboutUs() {
    return (
        <HomeLayout>
            {/* Changed bg-gray-900 to bg-gray-800 to match HomePage, and fixed padding/min-height */}
            <div className="flex flex-col text-white px-10 pt-10 min-h-[90vh] bg-gray-800">
                ...
                <div className="carousel w-1/2 my-10 mx-auto">
                    ...
                    <div id="slide4" className="carousel-item relative w-full">
                         <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
                            <img src={Priyanshu} className="w-40 rounded-full border-2 border-gray-400" />
                            <p className='text-xl text-gray-200'>Software Engineer .</p>
                            <h3 className='text-2xl font-semibold'>Priyanshu Singh</h3>
                            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                <a href="#slide1" className="btn btn-circle">❮</a> 
                                <a href="#slide3" className="btn btn-circle">❯</a>
                            </div>
